...
export const getDetailsMarketplacesMerchant = (params: GetDetailsMarketplaceMerchantParams, signal?: AbortSignal) => {
  const url = KEYS.MERCHANT_DETAIL.replace(':id', params.id);
  return httpInstance.get<GetDetailsMarketplacesMerchantResponse>(url, { signal }).then((res) => res);
};

export const getMarketplacesMerchantsList = (params: GetMarketplaceMerchantsListParams, signal?: AbortSignal) => {
  return httpInstance
...
export const createMarketplaceMerchant = (params: CreateMarketplaceMerchantParams, signal?: AbortSignal) => {
  return httpInstance.post(KEYS.MERCHANTS, params, { signal }).then((res) => res);
};
...
export const updateMarketplacesMerchant = (params: UpdateMarketplaceMerchantParams, signal?: AbortSignal) => {
  const url = KEYS.MERCHANT_DETAIL.replace(':id', params.id);
  return httpInstance.put(url, params, { signal }).then((res) => res);
};

export const deleteMarketplacesMerchant = (params: DeleteMarketplaceMerchantParams, signal?: AbortSignal) => {
  const url = KEYS.MERCHANT_DETAIL.replace(':id', params.id);
