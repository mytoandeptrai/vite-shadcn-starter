...
export function removeEmptyStringObject(
...
export const formatTimeFromSeconds = (
  ...
  if (days > 0) {
    return `${formatNumber(days)} ${getUnit(
      t,
      days,
      "day",
      "days"
    )} ${formatNumber(hours)} ${getUnit(
      t,
      hours,
      "hour",
      "hours"
    )} ${formatNumber(minutes)} ${getUnit(
      t,
      minutes,
      "minute",
      "minutes"
    )} ${formatNumber(remainingSeconds)} ${getUnit(
      t,
      remainingSeconds,
      "second",
      "seconds"
  ...
  if (hours > 0) {
    return `${formatNumber(hours)} ${getUnit(
      t,
      hours,
      "hour",
      "hours"
  ...
  return `${formatNumber(remainingSeconds)} ${getUnit(
    t,
    remainingSeconds,
    "second",
    "seconds"
