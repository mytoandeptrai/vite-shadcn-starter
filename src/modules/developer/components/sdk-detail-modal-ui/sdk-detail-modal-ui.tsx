      ...
      <DialogContent className='max-w-2xl max-h-[90vh] overflow-y-auto'>
        ...
        <div className='space-y-6 py-4'>
          ...
          <div className='space-y-4'>
            {sdk.version && (
              <div>
                <p className='text-sm font-medium text-muted-foreground mb-1'>{t('sdks.modal.version')}</p>
            ...
            {sdk.language && (
              <div>
                <p className='text-sm font-medium text-muted-foreground mb-1'>{t('sdks.modal.language')}</p>
            ...
            {sdk.platform && (
              <div>
                <p className='text-sm font-medium text-muted-foreground mb-1'>{t('sdks.modal.platform')}</p>
